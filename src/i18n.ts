  ...
  en: {
    ...
    settings: {
      ...
      unsavedChanges: {
        ...
        message: 'You have unsaved settings changes. Save them before closing?',
    ...
    auth: {
      ...
      errors: {
        ...
        codeExpired: 'Verification code is invalid or expired',
  ...
  ru: {
    ...
    settings: {
      ...
      unsavedChanges: {
        ...
        message: 'У вас есть несохранённые изменения в настройках. Сохранить их перед закрытием?',
    ...
    auth: {
      ...
      errors: {
        ...
        codeExpired: 'Код подтверждения недействителен или истёк',
  ...
  es: {
    ...
    settings: {
      ...
      unsavedChanges: {
        ...
        message: 'Tienes cambios de configuración sin guardar. ¿Guardarlos antes de cerrar?',
    ...
    auth: {
      ...
      errors: {
        ...
        codeExpired: 'Código inválido o expirado',
  ...
  fr: {
    ...
    settings: {
      ...
      unsavedChanges: {
        ...
        message: 'Vous avez des modifications de paramètres non enregistrées. Les enregistrer avant de fermer ?',
    ...
    auth: {
      ...
      errors: {
        ...
        codeExpired: 'Code invalide ou expiré',
  ...
  de: {
    ...
    settings: {
      ...
      unsavedChanges: {
        ...
        message: 'Sie haben ungespeicherte Einstellungsänderungen. Vor dem Schließen speichern?',
    ...
    auth: {
      ...
      errors: {
        ...
        codeExpired: 'Code ungultig oder abgelaufen',
  ...
  uk: {
    ...
    settings: {
      ...
      unsavedChanges: {
        ...
        message: 'У вас є незбережені зміни в налаштуваннях. Зберегти їх перед закриттям?',
    ...
    auth: {
      ...
      errors: {
        ...
        codeExpired: 'Код підтвердження недійсний або закінчився',
